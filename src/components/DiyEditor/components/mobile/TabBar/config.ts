    ...
    items: [
      {
        ...
        iconUrl: 'http://ximutest.oss-cn-chengdu.aliyuncs.com/econets/1-001.png',
        activeIconUrl: 'http://ximutest.oss-cn-chengdu.aliyuncs.com/econets/1-002.png'
      },
      {
        text: '分类',
        url: '/pages/index/category?id=3',
        iconUrl: 'http://ximutest.oss-cn-chengdu.aliyuncs.com/econets/2-001.png',
        activeIconUrl: 'http://ximutest.oss-cn-chengdu.aliyuncs.com/econets/2-002.png'
      },
      {
        text: '购物车',
        url: '/pages/index/cart',
        iconUrl: 'http://ximutest.oss-cn-chengdu.aliyuncs.com/econets/3-001.png',
        activeIconUrl: 'http://ximutest.oss-cn-chengdu.aliyuncs.com/econets/3-002.png'
      },
      {
        text: '我的',
        url: '/pages/index/user',
        iconUrl: 'http://ximutest.oss-cn-chengdu.aliyuncs.com/econets/4-001.png',
        activeIconUrl: 'http://ximutest.oss-cn-chengdu.aliyuncs.com/econets/4-002.png'
      }
    ]
  }
